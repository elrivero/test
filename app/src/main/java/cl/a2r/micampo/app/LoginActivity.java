...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected class LoginAsync extends AsyncTask<Void, Void, Void> {
        String title, msg;
        Boolean login;
        ...
        protected void onPostExecute(Void result) {
            ...
            if (login) {
                //ir a MainAtivity
                Intent intent = new Intent(LoginActivity.this, PredioActivity.class);
    ...
    public void chilterraLogin() {
        //Hacer Login en Chilterra
        ...
        AppService.setUserId(99);
        AppService.setUserEmail(email);
        AppService.setUserName(email);
        AppService.update();
